...
\arttime
% Estimate the time required to reproduce the artifact, providing separate estimates for the individual steps: 
% Artifact Setup, Artifact Execution, and Artifact Analysis.
\begin{itemize}
