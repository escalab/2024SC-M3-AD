...
__device__ inline void
complex_mul_mpmxu(wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_N, WMMA_K, half, wmma::row_major> &frag_F_real,
                                       ...
                                       wmma::fragment<wmma::accumulator, WMMA_M, WMMA_N, WMMA_K, half> &frag_out_real, wmma::fragment<wmma::accumulator, WMMA_M, WMMA_N, WMMA_K, half> &frag_out_imag)
{
    ...
    wmma::fragment<wmma::accumulator, WMMA_M, WMMA_N, WMMA_K, half> frag_buf_imag;
...
__global__ void layer_512_0_A100(half2 *in, half *F_real, half *F_imag)
{
    ...
    for (int i = 0; i < 512 * CONT_SIZE; i += NUM_WARP * 16 * 16)
    {
        ...
        // // complex_mul_mpmxu(frag_F_real, frag_F_imag, frag_in_real, frag_in_imag, frag_out_real, frag_out_imag);
        // complex_mul_mpmxu(frag_F_real, frag_in_real, frag_out_real);
