...
for i in 256 512 1024
do
    echo "Speed test: mpmxufft, FFT size: $i batchsize:1048576"
    ./mpmxufft_speed -b 1048576 -n $i
done
for i in 131072 262144 524288
do
    echo "Speed test: mpmxufft, FFT size: $i batchsize:2048"
    ./mpmxufft_speed -b 2048 -n $i
done
for i in 16777216 33554432 67108864 134217728
do
    echo "Speed test: mpmxufft, FFT size: $i batchsize:8"
    ./mpmxufft_speed -b 8 -n $i
done
