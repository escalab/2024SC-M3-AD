#include "mpmxufft_f32.h"
using namespace nvcuda;
const int WARP_SIZE = 32, WMMA_M = 16, WMMA_N = 16, WMMA_K = 8, CONT_SIZE = 16;

// __device__ inline void
// complex_mul(wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_N, WMMA_K, float, wmma::row_major> &frag_F_real, wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_N, WMMA_K, float, wmma::row_major> &frag_F_imag,
...
//     // //MOD
//     // for (int i = 0; i < 2 * frag_out_real.num_elements; i++)
//     // {
//     //     int idx = i % frag_out_real.num_elements;
//     //     frag_out_real.x[idx] = -frag_out_real.x[idx];
//     // }
...
__global__ void layer_256_0_A100(float2 *in, float *F_real, float *F_imag)
{
    ...
    // wmma::fragment<wmma::matrix_a, WMMA_M, WMMA_N, WMMA_K, float, wmma::row_major> frag_F_imag;
